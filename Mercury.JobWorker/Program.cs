        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                ...
                // Load DLLs dynamically into dictionary lookup
                    ...
                    services.Configure<WorkerConfig>(hostContext.Configuration.GetRequiredSection(nameof(WorkerConfig)));



                    // Redis Services
                    services
                        .Configure<RedisConfiguration>(hostContext.Configuration.GetRequiredSection("Redis"));
